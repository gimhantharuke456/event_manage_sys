            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <select name="genre" required>
						...
						<option value="Pupular">Most Pupular</option>
                ...
                <div class="form-group">
                    ...
                    <select name="show_timings" required>
                        <option value="9:30 AM">One Month</option>
                        <option value="12:30 PM">Three Months</option>
                        <option value="3:30 PM">Six Months</option>
                        <option value="6:30 PM">One Year</option>
                        <option value="6:30 PM">Life Time</option>
                    </select>
                </div>
                <div class="form-group">
